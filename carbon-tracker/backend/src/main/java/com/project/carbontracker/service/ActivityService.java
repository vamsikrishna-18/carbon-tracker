...
public class ActivityService {
    ...
    public Activity addActivity(ActivityRequest request) {
        ...
        int ecoPoints = calculateEcoPoints(emission);
        ...
        badgeService.recalculateBadges(savedActivity.getUserId());
    ...
    public Map<String, Object> getDashboardData(Long userId) {
        ...
        double totalEmission = Math.round(
                activities.stream()
                        .mapToDouble(a ->
